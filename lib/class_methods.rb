module IncludeByDefault #:nodoc:
  ...
  # This module contains the actual core functionality for inserting includes by default.
  # The other modules are a series of hacks to work around problems with ActiveRecord.
  module ClassMethods
